...
def get_corr_filenames(args, dir=None):
    ...
    corrPathPrefix = os.path.join(os.getcwd(), args.output)
    print('corrPathPrefix:',corrPathPrefix)
...
def get_class_junc_filenames(args, dir=None):
    ...
    print('outputClassPath:',outputClassPath)
...
def reference_parser(args, genome_chroms):
    ...
    if os.path.exists(referenceFiles):
        ...
        if not args.genename:
            ...
            subprocess.call([GTF2GENEPRED_PROG, path_to_gtf, referenceFiles, '-genePredExt', '-allErrors',
...
def run(args):
    ...
    if len(sys.argv) == one_file_args_length:
        loop = 1
    ...
    for i in range(1, loop + 1):
        if i == 1:
            ...
            if args.organism == 'mouse':
                ...
                path_to_gtf = "../../LONGTrec_LRGASP_Platform/lrgasp_gencode_vM28_sirvs.mouse.gtf"
                if args.cov_2 == 'default':
                    args.coverage = "../../LONGTrec_LRGASP_Platform/gold_std_ES"
                elif args.cov_2 == 'custom':
                    args.coverage = os.path.join("../../uploads/coverage_files", args.cov_dir_2)
            elif args.organism == 'manatee':
                ...
                args.genome = args.ref_2
                path_to_gtf = args.anno_2
                if args.cov_2 == 'custom':
                    args.coverage = os.path.join("../../uploads/coverage_files", args.cov_dir_2)
    ...
    if not args.skip_report:
        ...
        busco_tsv1 = glob.glob(os.path.join(args.dir, 'BUSCO_results.tsv'))[0]
        if len(sys.argv) == one_file_args_length:
            cmd = RSCRIPTPATH + " {d}/{f} {c} {j} {d} {o} {b} {s} your_tool{t} {pl} {l} {da} {comp} {bambu} {RNABloom} {rnaSPAdes} {StringTie2IsoQuant} {sirv_list} {ercc_list} {sequin_list}".format(d=utilitiesPath,
                                                                                                     f=RSCRIPT_REPORT,
                                                                                                     c=outputClassPath1,
                                                                                                     j=outputJuncPath1,
                                                                                                     o=rdata_out,
...
def main():
    ...
    if len(sys.argv) == one_file_args_length:
        ...
        parser.add_argument('anno_1', help="\t ?")
        parser.add_argument('ref_1', help="\t ?")
        parser.add_argument('cov_1', help="\t ?")
        parser.add_argument('cov_dir_1', help="\t ?")
    ...
    if args.organism == 'mouse':
        args.genome = "../../LONGTrec_LRGASP_Platform/lrgasp_grcm39_sirvs.fasta"
        path_to_gtf = "../../LONGTrec_LRGASP_Platform/lrgasp_gencode_vM28_sirvs.mouse.gtf"
        if args.cov_1 == 'default':
            args.coverage = "../../LONGTrec_LRGASP_Platform/gold_std_ES"
        elif args.cov_1 == 'custom':
    ...
    args.isoforms = next((os.path.join("../../uploads/transcriptome_file1", file)
                         for file in os.listdir("../../uploads/transcriptome_file1")
    ...
    if not args.gtf:
        ...
        if len(sys.argv) != one_file_args_length:
            args.isoforms2 = rename_isoform_seqids(f"../../{args.isoforms2}", args.force_id_ignore)
