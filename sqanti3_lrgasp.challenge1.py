...
def run(args):
    ...
    if not args.skip_report:
        ...
        cmd = RSCRIPTPATH + " {d}/{f} {c} {j} {d} {o} {org} {t}your_tool {p} {l} {da} {comp} {bambu} {RNABloom} {rnaSPAdes} {StringTie2IsoQuant} {sirv_list} {ercc_list} {sequin_list}".format(d=utilitiesPath, f=RSCRIPT_REPORT, c=outputClassPath, j=outputJuncPath, o=rdata_out, org=args.organism ,t=args.tool, p=args.platform, l=args.library_preparation, da=args.data_category,comp=args.comparison,
...
def main():
    ...
    parser.add_argument('comp_RNA_Bloom')
    parser.add_argument('comp_rnaSPAdes')
    parser.add_argument('comp_StringTie2_IsoQuant')
    ...
    if args.genome == 'LRGASP_DATA':
        if args.organism == 'mouse':
            ...
            print('There is no reference file yet for args.genome')
        else:
    ...
    if args.annotation == 'LRGASP_DATA':
        if args.organism == 'mouse':
            ...
            print('There is no annotation file yet for args.genome')
        else:
            print('ERROR: User should provide genome file when organism is set to custom...')
    else:
